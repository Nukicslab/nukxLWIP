...
//============================================================================
/*
class lwipep_ipsec_tunnel_interface_lwipep_segw
{
public:
	virtual void write_sdu(uint16_t rnti, uint32_t lcid, srslte::byte_buffer_t *sdu) = 0;
...
class lwipep_xw_interface_lwipep_segw
{
public:
	virtual void write_pdu(uint16_t rnti, uint32_t lcid, srslte::byte_buffer_t *pdu) = 0;
	virtual void stop() = 0;
...
*/
class lwipep_xw_interface_lwipep
{
public:
//	virtual void write_sdu(uint16_t rnti, uint32_t lcid, srslte::byte_buffer_t *sdu) = 0;
...
class lwipep_interface_lwipep_xw
{
public:
	virtual void write_pdu(uint16_t rnti, uint32_t lcid, srslte::byte_buffer_t *sdu) = 0;
...
/*
class lwipep_spgw_interface_lwipep_xw
{
	virtual void	receive_from_lwipep() = 0;
	virtual void	send_to_lwipep() = 0;	
	virtual void	write_pdu(uint16_t rnti, uint32_t lcid, srslte::byte_buffer_t *sdu) = 0;
};

class lwipep_spgw_interface_lwipep_ipsec_tunnel
{
	virtual void	receive_from_ue() = 0;
	virtual void	send_to_ue() = 0;
};
*/
class lwipep_interface_rrc
{
public:
	virtual void add_user(uint16_t rnti) = 0;
	virtual void rem_user(uint16_t rnti) = 0;
	/*
	virtual void reset(uint16_t rnti) = 0;
	virtual void add_bearer(uint16_t rnti) = 0;
...
{
public:
	virtual uint32_t get_buffer_state(uint16_t rnti, uint32_t lcid) = 0;
};
...
class gtpu_interface_lwipep
{
public:
	virtual void write_pdu(uint16_t rnti, uint32_t lcid, srslte::byte_buffer_t *sdu) = 0;
};

class lwipep_interface_gtpu
{
public:
	virtual void write_sdu(uint16_t rnti, uint32_t lcid, srslte::byte_buffer_t *sdu) = 0;
};
