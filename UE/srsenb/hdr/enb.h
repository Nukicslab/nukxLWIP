...
#include "upper/lwipep.h"
#include "upper/lwipep_xw.h"
#include "upper/enb_lwipep_handle_report.h"
...
private:
  ...
  srsenb::lwipep lwipep;
  srsenb::lwipep_xw lwipep_xw;
  srsenb::lwipep_hdl_rpt	lwipep_hdl_rpt;
  ...
  srslte::log_filter  lwipep_log;
  srslte::log_filter  lwipep_xw_log;
  srslte::log_filter	lwipep_hdl_rpt_log;
