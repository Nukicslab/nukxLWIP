...
public:
  ...
  bool init(std::string gtp_bind_addr_, std::string mme_addr_, std::string m1u_multiaddr_, std::string m1u_if_addr_, pdcp_interface_gtpu *pdcp_, lwipep_interface_gtpu* lwipep_, srslte::log *gtpu_log_, bool enable_mbsfn = false);
  void stop();
  ...
  // gtpu_interface_pdcp change to lwipep_interface_pdcp
...
private:
  ...
  srsenb::lwipep_interface_gtpu	*lwipep;
  srslte::log                 *gtpu_log;
  ...
  public:
    ...
    bool init(std::string m1u_multiaddr_, std::string m1u_if_addr_, pdcp_interface_gtpu *pdcp_, lwipep_interface_gtpu* lwipep_, srslte::log *gtpu_log_);
    void stop();
  private:
    void run_thread();
