...
class pdcp :  public pdcp_interface_rlc,
			  public pdcp_interface_lwipep,
              public pdcp_interface_gtpu,
              public pdcp_interface_rrc
{
public:
  virtual ~pdcp() {};
  void init(rlc_interface_pdcp *rlc_, lwipep_interface_pdcp* lwipep_, rrc_interface_pdcp *rrc_, gtpu_interface_pdcp *gtpu_, srslte::log *pdcp_log_);
  void stop(); 
...
private: 
  ...
  class user_interface_lwipep : public srsue::lwipep_interface_pdcp
  {
  public:
	  uint16_t rnti; 
	  srsenb::lwipep_interface_pdcp *lwipep; 
