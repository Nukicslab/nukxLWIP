...
public:
	...
	class user_interface_lwipep_hdl_rpt : public srsue::lwipep_hdl_rpt_interface_lwipep
	{
	public:
		uint16_t rnti; 
		srsenb::lwipep_hdl_rpt_interface_lwipep	*lwipep_hdl_rpt;
	...
	public: 
		...
		user_interface_lwipep_hdl_rpt	lwipep_hdl_rpt_itf;
