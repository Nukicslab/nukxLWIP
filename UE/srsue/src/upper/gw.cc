...
void gw::init(pdcp_interface_gw *pdcp_, lwipep_interface_gw *lwipep_, nas_interface_gw *nas_, srslte::log *gw_log_, srslte::srslte_gw_config_t cfg_)
{
      ...
      if (ip_pkt->version == 4 || ip_pkt->version == 6) {
        ...
        if (pkt_len == pdu->N_bytes) {
          ...
          if (pdcp->is_lcid_enabled(cfg.lcid)) {
			...
			//================================================
            lwipep->write_sdu(cfg.lcid, pdu, false);
			//================================================
