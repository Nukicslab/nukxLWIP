...
#include "upper/lwipep_ipsec.h"
#include "upper/ue_lwipep_handle_report.h"
#ifndef SRSUE_UE_H
#define SRSUE_UE_H
...
private:
  ...
  srsue::lwipep_hdl_rpt	lwipep_hdl_rpt;
  srsue::rrc         rrc;
  srsue::nas         nas;
  srsue::gw          gw;
  ...
  srslte::log_filter	lwipep_ipsec_log;
