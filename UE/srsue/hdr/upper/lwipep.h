...
//	pthread_rwlock_t rwlock;
	...
	srsue::lwipep_hdl_rpt_interface_lwipep	*lwipep_hdl_rpt;
	...
	class lwipep_hdl_rpt_interface_lwipep : public srsue::lwipep_hdl_rpt_interface_lwipep
	{
	public:
		uint16_t rnti; 
		srsue::lwipep_hdl_rpt_interface_lwipep	*lwipep_hdl_rpt;
	...
	lwipep_hdl_rpt_interface_lwipep	*hdl_rpt;
