...
public:
  gw();
  void init(pdcp_interface_gw *pdcp_, lwipep_interface_gw *lwipep_, nas_interface_gw *nas_, srslte::log *gw_log_, srslte::srslte_gw_config_t);
  void stop();
