...
// Cat 4 UE 150752 - Max number of DL-SCH transport block bits received within a TTI	
// 3GPP 36.306 Table 4.1.1
// Cat 5 UE 299552
// Cat 8 UE 2998560
#define SRSLTE_MAX_BUFFER_SIZE_BITS  299552
#define SRSLTE_MAX_BUFFER_SIZE_BYTES (SRSLTE_MAX_BUFFER_SIZE_BITS/8)
#define SRSLTE_BUFFER_HEADER_OFFSET  1020

#define SRSLTE_BUFFER_POOL_LOG_ENABLED true
