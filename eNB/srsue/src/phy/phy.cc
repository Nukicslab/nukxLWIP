...
bool phy::init(srslte::radio_multi* radio_handler, mac_interface_phy *mac, lwipep_interface_phy *lwipep, rrc_interface_phy *rrc,
...
void phy::set_crnti(uint16_t rnti) {
  ...
  if (lwipep != NULL)	lwipep->set_crnti(rnti);
}
